    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                // Hotkey
                SettingsGroup(title: "Phím tắt", color: .blue) {
                ...
                // Input Method
                SettingsGroup(title: "Kiểu gõ", color: .blue) {
                    VStack(alignment: .leading, spacing: 8) {
                ...
                // Code Table
                SettingsGroup(title: "Bảng mã", color: .blue) {
                ...
                // Basic Options
                SettingsGroup(title: "Tùy chọn", color: .blue) {
                    VStack(alignment: .leading, spacing: 10) {
