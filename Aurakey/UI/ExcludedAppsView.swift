    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                // Smart Switch
                SettingsGroup(title: "Smart Switch", color: .red) {
                ...
                SettingsGroup(title: "Loại trừ ứng dụng", color: .red) {
                ...
                // Excluded apps list
                SettingsGroup(title: "Danh sách ứng dụng loại trừ (\(viewModel.preferences.excludedApps.count))", color: .red) {
                    if viewModel.preferences.excludedApps.isEmpty {
                        VStack(spacing: 8) {
