...
final class AudioManager {
    ...
    private let audioQueue = DispatchQueue(label: "com.tdev.aurakey.audio", qos: .userInteractive)
    ...
    func playBeep() {
        ...
        audioQueue.async { [weak self] in
            ...
            // Refresh audio system on main thread
            DispatchQueue.main.async {
                self.refreshAudioSystem()
                // Play beep after refresh completes
                NSSound.beep()
            }
        }
    }
