...
/// Stores dictionaries in App Group container
class VNDictionaryManager {
    ...
    private let appGroupIdentifier = "7E6Z9B4F2H.com.tdev.inputmethod.Aurakey"

    // Local storage path in App Group
    private var dictionaryDirectory: URL {
        ...
        guard let containerURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: appGroupIdentifier) else {
            ...
            let dictDir = appSupport.appendingPathComponent("Aurakey/Dictionaries")
